...
def main():
    ...
    checkpoint_path = f"outputs/pointwise/checkpoints/{model}_checkpoint_500_v2.csv"
    ...
    save_intermediate_outputs(sed_outputs_subset, f"outputs/pointwise/final/intermediate_results_{model}_500_v2.csv")

    metrics = compute_metrics_from_pointwise_csv(f"outputs/pointwise/final/intermediate_results_{model}_500_v2.csv")
    print(metrics)
